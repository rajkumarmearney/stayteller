...
class RouterServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleNamespace = 'Modules\Voucher\Controllers';

    protected $adminModuleNamespace = 'Modules\Voucher\Admin';
