<?php
    ...
    class PayoutRequestNotificationListener
    {
        ...
        protected function sendEmailCreate($event){
            ...
            Mail::to($event->user->email)->send(new PayoutRequestCreatedEmail($event->user,$event->payout_request,'agent'));
        ...
        protected function sendEmailUpdate($event){
            ...
            Mail::to($event->user->email)->send(new PayoutRequestChangedEmail($event->user,$event->payout_request,'agent'));
        ...
        protected function sendEmailReject($event){
            ...
            Mail::to($event->user->email)->send(new PayoutRequestRejectedEmail($event->user,$event->payout_request,'agent'));
        ...
        protected function sendEmailDelete($event){
            ...
            Mail::to($event->user->email)->send(new PayoutRequestDeletedEmail($event->user,$event->payout_request,'agent'));
