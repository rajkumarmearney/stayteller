    ...
    <div class="container">
            ...
            <div class="col-sm-8">
                <div class="listing_single_description style2">
                    ...
                    <div class="text-danger mb30 room_header"> {{ $translation->title ?? '' }}
                        <span
                            class="room_price">{{ $row['display_price'] ? $row['display_price'] : '' }}/{{__("Month")}}</span>
                        @if($row->is_sold)
                    ...
                    <div class="gpara second_para white_goverlay mt10 mb10">{!!
                        clean(Str::words($translation->content,50)) !!}</div>
        ...
        <div class="row">
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <ul class="list-inline-item">
                                        <li>
                                            <p><span>{{ $roomdatainfo->price_per_month ? $roomdatainfo->price_per_month : __('None') }}</span>
                                            </p>
                                        </li>
                                        <li>
                                            <p><span>{{ $roomdatainfo->deposite ? $roomdatainfo->deposite : 0 }}</span>
                                            </p>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="float-right">
                                ...
                                @else
                                <a class="btn btn-block btn-thm" data-toggle="modal"
                                    data-target="#enquiry_form_modal">{{__("Sold Out")}}</a>
                                @endif
                            </div>
                        </div>
            ...
            <div class="col-sm-4 mt50">
                ...
                <div class="text-sm font-bold">1 night <span class="text-text">starting from</span> Wed 19 Oct, 2022
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row">
                            <div class="flex flex-col items-center justify-center w-72">
                                <img src="https://book.zostel.com/static/media/gray-zobu.018014d9.svg" alt="zobu"
                                    class="h-40">
                ...
                <div class="row">
                        ...
                        <div class="listing_single_description style2">
                            <div class="lsd_list">
                                <ul class="mb0">
                                    ...
                                    <li class="list-inline-item"><a href="#">{{  __($translationCategory->name) }}</a>
                                    </li>
                                    @endif
                                    @if(!empty($row['bed']))
                                    <li class="list-inline-item"><a href="#">{{ __("Beds") }}:
                                            {{ !empty($row['bed']) ? $row['bed'] : ''}}</a></li>
                                    @endif
                        ...
                        <div class="additional_details">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-6 ">
                                    ...
                                    <ul class="list-inline-item">
                                        <li>
                                            <p><span>{{ $row->category ? $row->category->name : '' }}</span></p>
                                        </li>
                                        <li>
                                            <p><span>{{ $row->pool_size ? size_unit_format($row->pool_size) : 0 }}</span>
                                            </p>
                                        </li>
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <ul class="list-inline-item">
                                        <li>
                                            <p>{{ __('Near By Facilities ') }} :</p>
                                        </li>

                                    </ul>
                                    <ul class="list-inline-item">
                                        <li>
                                            <p><span>{{ $row->remodal_year ? $row->remodal_year : __('None') }}</span>
                                            </p>
                                        </li>
                    ...
                    <div class="col-lg-12" id="location">
                        <div class="application_statics mt30">
                            <h4 class="mb30">{{ __("Location") }} <small
                                    class="application_statics_location float-right">{{ !empty($location->name) ? $location->name : '' }}</small>
                            </h4>
                                ...
                                <div class="thumb">
                                    ...
                                    <div class="overlay_icon">
                                        <a href="#"><img class="map_img_icon"
                                                src="{{asset('findhouse/images/header-logo.png')}}"
                    ...
                    <div class="col-lg-12" id="review">
                        @include('Agencies::frontend.detail.review', ['review_service_id' => $row['id'],
