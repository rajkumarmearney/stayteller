                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        @if(is_default_lang())
                            ...
                            <div class="panel">
                                <div class="panel-title"><strong>{{__('Body width')}}</strong></div>
                                <div class="panel-body">
                                    <select name="body_width" class="form-control" >
                                        <option value="normal" {{ ( $row->body_width ?? '') == 'normal' ? 'selected' : ''  }}>{{__("Normal")}}</option>
                                        <option value="transparent" {{( $row->body_width ?? '') == 'max1600' ? 'selected' : ''  }}>{{__('Max 1600px')}}</option>
                                    </select>
                                </div>
                            </div>
                        @endif
